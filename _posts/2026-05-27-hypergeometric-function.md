...
**Challenge to the reader:** Can you find another elementary function hiding inside a ${}_2F_1$ with different parameters? Try ${}_2F_1(1,1;2;-z)$ and email me the answer.
...
Now plug into ${}_2F_1(n,1;1;-z)$. We get:

$$
{}_2F_1(n,1;1;-z) = \sum_{k=0}^{\infty} \frac{(n)_k (1)_k}{(1)_k} \frac{(-z)^k}{k!}
$$

Since $(1)_k = k!$, the numerator and denominator cancel:

$$
\sum_{k=0}^{\infty} \frac{(n)_k}{k!} (-z)^k
$$
...
$$
{}_2F_1(n,1;1;-z) = \sum_{k=0}^{\infty} (-1)^k \binom{n+k-1}{k} z^k
$$
...
$$
\frac{a_{k+1}}{a_k} = \frac{(a+k)(b+k)}{(c+k)(k+1)} z
$$
...
The power series converges only for $\lvert z \rvert < 1$.
