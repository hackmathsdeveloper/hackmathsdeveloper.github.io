...
Modern work shows these come from deep congruence properties of modular forms and their \(q\)-expansions, where coefficients of certain power series satisfy infinite families of congruences modulo powers of primes. [math.harvard](https://www.math.harvard.edu/media/Narayanan-Modular-Forms-Thesis.pdf)

***

## Modular forms and congruence subgroups

From a higher vantage point, congruence conditions on coefficients of modular forms are tied to the arithmetic of congruence subgroups of \(\mathrm{SL}_2(\mathbb Z)\). [emergentmind](https://www.emergentmind.com/topics/ramanujan-s-congruences)
...
- Fast exponentiation modulo \(n\) for cryptographic primitives (RSA, Diffie–Hellman, etc.) via repeated squaring and modular reduction. [youtube](https://www.youtube.com/watch?v=B1gD6540uWA)
...
Ramanujan’s partition congruences sit at the intersection of: [people.mpim-bonn.mpg](https://people.mpim-bonn.mpg.de/zagier/files/preprints/RamanujanCongruences.pdf)
