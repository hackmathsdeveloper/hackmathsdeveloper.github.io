...
It is essentially a symmetry around:
...
has a branch cut along positive real axis.

Use a keyhole contour around the branch cut.

The function has one pole at:
...
measures the discontinuity of complex powers across the branch cut.
...
The RHS predicts this perfectly because:
...
causes exponentials to cancel, leaving precisely the sine product.
...
Reflection formula represents a symmetry:
...
is the multiplicative analogue of exponentials,
...
measures the obstruction to extending factorial symmetry across negative numbers.
